...
model.fc = nn.Linear(num_ftrs, 4)  # 4-class output
...
# === save model ===
torch.save(model.state_dict(), "multi_class_resnet.pth")
print("Model saved as multi_class_resnet.pth")
...
plt.tight_layout()
plt.savefig("multi_class_resnet_training_curves.png")
plt.show()